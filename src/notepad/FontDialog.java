...
menu parent;
    ...
    public FontDialog(menu parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.parent=parent;
        setFont();
...
//make a String array and fill it with the AvailableFontFamilyNames
...
jList3.setListData(DEFAULT_FONT_SIZE_STRINGS);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FontDialog dialog = new FontDialog(new menu(), true);
